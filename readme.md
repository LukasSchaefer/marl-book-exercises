...
These exercises cover the implementation of a simple tabular multi-agent reinforcement learning algorithm, training deep multi-agent reinforcement learning agents using the [book codebase](https://github.com/marl-book/codebase), and visualising learned policies and value functions. The exercises are not meant to be comprehensive and do not cover large parts of the codebase, but rather encourage you to explore and engage with the codebase and some of the material of the textbook.
